...
const Swift = () => {
  return (
    <div>
        ...
        <p className='text-[25px] font-bold underline text-center leading-[80px] '>Suzuki Swift 2024 Price in Pakistan, Images, Reviews & Specs</p>
        <div> <img src="/Swift.webp" alt="this is civic " width={250} height={250} className='h-64 w-[350px] mx-[590px]' /></div>
        ...
        <p className='text-2xl text-green-500 text-center mr-10'>PKR 45,50,000</p>
