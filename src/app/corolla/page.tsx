...
const Corolla = () => {
  return (
    <div>
        ...
        <p className='text-[25px] font-bold underline text-center leading-[80px] '>Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</p>
        <div> <img src="/Corolla.webp" alt="this is corolla " width={250} height={250} className='h-64 w-[350px] mx-[590px]' /></div>
        ...
        <div className=''><button className=' text-blue-800 bg-white
        h-10 w-36  pt-1 mb-3 pr-1 rounded border-2 border-solid border-blue-800'>Car Inspection</button></div>
        </div>
        ...
        <p className='text-2xl text-green-500 text-center mr-10'>PKR 65,50,000</p>

        <div className='my-[30px]'>
        <Link href= "/contact"><button className='h-12 w-40 rounded bg-blue-700 hover:bg-blue-800 ml-[660px] text-white '>Make Payment</button></Link>
        </div>
        </div>
